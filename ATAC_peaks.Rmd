...
path <- "/Volumes/JD_WD2/JRD_CBDMLab/1_JRD_CBDM_PROJECTS/ProjectFolders/T-TregEpigenome/Data/1_Experimental/ATAC/Master_peaks/R/temp/Batch1/"
...
+ for batch1: *Removed 4 rows containing non-finite values (stat_boxplot)*, need to add pseudo before log?
...
#### Plot distribution of peaks across chromsomes
+ goal = bar plot, turned on side, facet on sample



#### Plot distribution of read counts across each chromsome?
+ goal = boxplots
+ goal = histograms, bin size and limits will be key for clear data
