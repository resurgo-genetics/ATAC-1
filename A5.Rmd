...
+ can I get a trendline on the matplots? using ggplot2?
+ can I dim reduce the results of APcluster to help evaluation?
<br>

#### Hclust on random samples generated from **QN normalized** set of all strong peaks
```{r hclust}
...
#### Km + Hclust on random samples generated from **QN normalized** set of all strong peaks
...
##---- heatmap results across samples ----------------------------------------------------------------------------
...
## plot each cluster different color, intensity/alpha = signal
## ggplot?
...
path <- "/Volumes/JD_WD2/JRD_CBDMLab/1_JRD_CBDM_PROJECTS/ProjectFolders/T-TregEpigenome/Data/1_Experimental/ATAC/Analyses/A5-all-ttreg/2rpm-filtered/plots/"
pdf(paste0(path,"a5-qn-apclust-16-matplots.pdf"), width=15, height=15)
...
############# can I do matplots in ggplot and add trendline? write function for it then apply?
...
**Purgatory** clustering from 2p5 rpm cutoff, non-QN-norm (may delete if 2rpm looks good)
