...
#### Start clustering with samples of data
+ Pseudo:
...
#### Annotate peaks with closest gene, use as rownames dim in read count matrix
+ do this with chr,start,end above
+ then set gene names as row.names in matrix?
