...
pheatmap(sl[[3]], color= niceCols, clustering_distance_rows = 'manhattan', clustering_distance_cols = 'manhattan')
pheatmap(sl[[3]], color= niceCols, clustering_distance_rows = 'manhattan', clustering_distance_cols = 'manhattan',
...
# so far best: mink+ward.D2 (really, all method similar), max+ward.D2, euclidean + ward.D, euclid (avg=single=mcq=median)
