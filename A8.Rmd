...
#### -- export ---------------------------------------------------------------------------------------------------
path <- "/Volumes/JD_WD2/JRD_CBDMLab/1_JRD_CBDM_PROJECTS/ProjectFolders/T-TregEpigenome/Data/1_Experimental/ATAC/Analyses/A8-all-samples/peaks/"
save(merge_result_table, file = paste0(path,"merge_result_table,",".RDa"))

# csv
write.csv(merge_result_table, file = paste0(path,"merge_result_table",".csv"))
```
<br>
...
# melt
datm <- melt(merge_result_table, id.vars = c(names(dat[1:7])))
...
#### Plot stats from merging replicates
```{r rep_merge_stats}
#### -- extract sample information from filenames ----------------------------------------------------------------
# set path
